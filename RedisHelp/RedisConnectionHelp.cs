...
namespace RedisHelp
{
    ...
    public static class RedisConnectionHelp
    {
        ...
        private static readonly string RedisConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["RedisConnection"]?.ConnectionString;
        ...
        public static ConnectionMultiplexer GetManager(string connectionString = null)
        {
            ...
            try
            {
                ...
                string RedisConnectionStr = string.IsNullOrEmpty(connectionString)?RedisConnectionString:"";// System.Configuration.ConfigurationManager.AppSettings["RedisConnection"] ?? "";
            ...
            {
                log4net.ILog log4er = log4net.LogManager.GetLogger("RedisHelper");
                log4er.Warn("RedisConnectionHelp:" + ex.Message);
            }
    ...
    public sealed class RedisNewConnection
    {
        ...
        //暂存所有链接，一个IP只创建一个链接
        private static Lazy<Dictionary<string, IConnectionMultiplexer>> ODictConnMutiplxer = new Lazy<Dictionary<string, IConnectionMultiplexer>>(() =>
        {
            Dictionary<string, IConnectionMultiplexer> dictRedisConnMutipler = new Dictionary<string, IConnectionMultiplexer>();
            try
            {
                string RedisConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["RedisConnection"]?.ConnectionString;
        ...
        /// <returns></returns>
        public IConnectionMultiplexer GetEndPointConnMutipler(string EndPoint)
        {
        ...
        /// <returns></returns>
        public IConnectionMultiplexer GetConnMutiplxer(RedisKey Key, IConnectionMultiplexer OConnMutiplxer, int dbNum = 0)
        {
            IConnectionMultiplexer OConnectionMultiplexer = null;
